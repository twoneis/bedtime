...
class _GetUpState extends State<GetUp> {
  ...
  void initState() {
    ...
    final settingsAndroid = new AndroidInitializationSettings('newicon');
    final settingsIOS = new IOSInitializationSettings(
  ...
  static var androidPlatformChannelSpecifics = new AndroidNotificationDetails(
      'daily channel id', 'daily channel name', 'daily channel description');
              ...
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  new ListTile(
                    ...
                    title: new Text("You should go to bed at " +
                        hours.toString() +
                        ":" +
                        minutes.toString()),
                    trailing: FlatButton(
                      ...
                      onPressed: () async {
                        print("starting setting notification");
                  ...
                  new ListTile(
                    subtitle: new Text(
                      "This app can not replace medical advice.",
            ...
            children: <Widget>[
              ...
              Padding(
                  ...
                  child: new DateTimePickerFormField(
                    ...
                    initialTime:
                        TimeOfDay.fromDateTime(DateTime(0, 0, 0, 6, 30)),
